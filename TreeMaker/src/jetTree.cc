...
*/
	...
	if ((SubJet_csv_ < -1) || (SubJet_csv_ > 1)) SubJet_csv_ = -1;
      ...
      trackSipdSig_0_t.push_back(trackSipdSig_0_);
      trackSipdSig_1_0_t.push_back(trackSipdSig_1_0_);
      trackSipdSig_0_0_t.push_back(trackSipdSig_0_0_);
      trackSipdSig_1_1_t.push_back(trackSipdSig_1_1_);
      trackSipdSig_0_1_t.push_back(trackSipdSig_0_1_);
      trackSip2dSigAboveCharm_0_t.push_back(trackSip2dSigAboveCharm_0_);
      trackSip2dSigAboveBottom_0_t.push_back(trackSip2dSigAboveBottom_0_);
      trackSip2dSigAboveBottom_1_t.push_back(trackSip2dSigAboveBottom_1_);
      tau1_trackEtaRel_0_t.push_back(tau1_trackEtaRel_0_);
      tau1_trackEtaRel_1_t.push_back(tau1_trackEtaRel_1_);
      tau1_trackEtaRel_2_t.push_back(tau1_trackEtaRel_2_);
      tau0_trackEtaRel_0_t.push_back(tau0_trackEtaRel_0_);
      tau0_trackEtaRel_1_t.push_back(tau0_trackEtaRel_1_);
      tau0_trackEtaRel_2_t.push_back(tau0_trackEtaRel_2_);
      tau_vertexMass_0_t.push_back(tau_vertexMass_0_);
      tau_vertexEnergyRatio_0_t.push_back(tau_vertexEnergyRatio_0_);
      tau_vertexDeltaR_0_t.push_back(tau_vertexDeltaR_0_);
      tau_flightDistance2dSig_0_t.push_back(tau_flightDistance2dSig_0_);
      tau_vertexMass_1_t.push_back(tau_vertexMass_1_);
      tau_vertexEnergyRatio_1_t.push_back(tau_vertexEnergyRatio_1_);
      tau_flightDistance2dSig_1_t.push_back(tau_flightDistance2dSig_1_);
      jetNTracks_t.push_back(jetNTracks_);
      nSV_t.push_back(nSV_);
      massPruned_t.push_back(massPruned_);
      flavour_t.push_back(flavour_);
      nbHadrons_t.push_back(nbHadrons_);
      ptPruned_t.push_back(ptPruned_);
      etaPruned_t.push_back(etaPruned_);
...
jetTree::SetBranches(){
  ...
  if(isFATJet_ || isAK8PuppiJet_ || isCA15PuppiJet_){
    ...
    if(isCA15PuppiJet_){
      ...
      AddBranch(&trackSipdSig_0_t, "_trackSipdSig_0" );
      AddBranch(&trackSipdSig_1_0_t, "_trackSipdSig_1_0" );
      AddBranch(&trackSipdSig_0_0_t, "_trackSipdSig_0_0" );
      AddBranch(&trackSipdSig_1_1_t, "_trackSipdSig_1_1" );
      AddBranch(&trackSipdSig_0_1_t, "_trackSipdSig_0_1" );
      AddBranch(&trackSip2dSigAboveCharm_0_t, "_trackSip2dSigAboveCharm_0" );
      AddBranch(&trackSip2dSigAboveBottom_0_t, "_trackSip2dSigAboveBottom_0" );
      AddBranch(&trackSip2dSigAboveBottom_1_t, "_trackSip2dSigAboveBottom_1" );
      AddBranch(&tau1_trackEtaRel_0_t, "_tau1_trackEtaRel_0" );
      AddBranch(&tau1_trackEtaRel_1_t, "_tau1_trackEtaRel_1" );
      AddBranch(&tau1_trackEtaRel_2_t, "_tau1_trackEtaRel_2" );
      AddBranch(&tau0_trackEtaRel_0_t, "_tau0_trackEtaRel_0" );
      AddBranch(&tau0_trackEtaRel_1_t, "_tau0_trackEtaRel_1" );
      AddBranch(&tau0_trackEtaRel_2_t, "_tau0_trackEtaRel_2" );
      AddBranch(&tau_vertexMass_0_t, "_tau_vertexMass_0" );
      AddBranch(&tau_vertexEnergyRatio_0_t , "_tau_vertexEnergyRatio_0");
      AddBranch(&tau_vertexDeltaR_0_t, "_tau_vertexDeltaR_0" );
      AddBranch(&tau_flightDistance2dSig_0_t, "_tau_flightDistance2dSig_0" );
      AddBranch(&tau_vertexMass_1_t, "_tau_vertexMass_1" );
      AddBranch(&tau_vertexEnergyRatio_1_t, "_tau_vertexEnergyRatio_1" );
      AddBranch(&tau_flightDistance2dSig_1_t, "_tau_flightDistance2dSig_1" );
      AddBranch(&jetNTracks_t, "_jetNTracks" );
      AddBranch(&nSV_t, "_nSV_" );
      AddBranch(&massPruned_t , "_massPruned");
      AddBranch(&flavour_t, "_flavour" );
      AddBranch(&nbHadrons_t , "_nbHadrons");
      AddBranch(&ptPruned_t , "_ptPruned");
      AddBranch(&etaPruned_t , "_etaPruned");
    }
...
jetTree::Clear(){
  ...
  trackSipdSig_0_t.clear();
  trackSipdSig_1_0_t.clear();
  trackSipdSig_0_0_t.clear();
  trackSipdSig_1_1_t.clear();
  trackSipdSig_0_1_t.clear();
  trackSip2dSigAboveCharm_0_t.clear();
  trackSip2dSigAboveBottom_0_t.clear();
  trackSip2dSigAboveBottom_1_t.clear();
  tau1_trackEtaRel_0_t.clear();
  tau1_trackEtaRel_1_t.clear();
  tau1_trackEtaRel_2_t.clear();
  tau0_trackEtaRel_0_t.clear();
  tau0_trackEtaRel_1_t.clear();
  tau0_trackEtaRel_2_t.clear();
  tau_vertexMass_0_t.clear();
  tau_vertexEnergyRatio_0_t.clear();
  tau_vertexDeltaR_0_t.clear();
  tau_flightDistance2dSig_0_t.clear();
  tau_vertexMass_1_t.clear();
  tau_vertexEnergyRatio_1_t.clear();
  tau_flightDistance2dSig_1_t.clear();
  jetNTracks_t.clear();
  nSV_t.clear();
  massPruned_t.clear();
  flavour_t.clear();
