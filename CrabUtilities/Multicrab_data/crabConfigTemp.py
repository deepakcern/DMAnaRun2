...
workname='data_20190820_test'
reqname='SingleElectron-Run2016H-03Feb2017_ver3-v1'
dataset='/SingleElectron/Run2016H-03Feb2017_ver3-v1/MINIAOD'
...
config.JobType.pyCfgParams = ['runOnMC=False','period=H']
...
config.Data.unitsPerJob = 10#EPLS
...
config.Data.outLFNDirBase = '/store/group/phys_exotica/bbMET/monoH_2016_ntuples_20Aug/test' 
